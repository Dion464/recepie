    ...
    <footer className="bg-white/80 backdrop-blur-md mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/favorite" className="text-gray-600 hover:text-orange-500 transition-colors">
                  Favorites
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-100 pt-8 text-center">
          <p className="text-gray-500">© {new Date().getFullYear()} Recipe App. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
